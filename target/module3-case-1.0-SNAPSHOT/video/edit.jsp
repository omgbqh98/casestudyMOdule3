...
<div class="container">
    ...
    <p>des</p>
    <input type="text" name="des" value="${video.des}">
        </div>
        <div class="form-group">

    <p>image</p>
    <input type="text" name="image" value="${video.image}">
        </div>
        <div class="form-group">

<%--    <p>video</p>--%>
<%--    <input disabled type="text" name="link" value="${video.link}" >--%>
<%--        </div>--%>
<%--        <div class="form-group">--%>

<%--    <p>your id</p>--%>
<%--    <input disabled type="text" name="idUser" value="${idUser}" >--%>
<%--        </div>--%>

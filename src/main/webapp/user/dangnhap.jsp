...
--*/
        ...
        .demo-1 .large-header {
            background-image: url('../hinhnendangnhap.jpg');
            ...
            <div class="main-agileits">
                ...
                <div class="form-w3-agile">
                    ...
                    <form action="/login" method="post">
                        ...
                        <p class="p-bottom-w3ls">Back to Home Page<a class href="/video">  Click here</a></p>
                        <p class="p-bottom-w3ls1">New User?<a class href="dangky.jsp">  Register here</a></p>
                        <div class="clear"></div>
